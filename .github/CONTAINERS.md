...
A special Docker image including **pyafv** 0.4.10, **OpenMPI**, and the Python package `mpi4py` is also available on [Docker Hub](https://hub.docker.com/layers/wwang721/pyafv/rockfish-mpi).
